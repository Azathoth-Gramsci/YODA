from lib.cytoreactors.design.program import Program
...
class ReactorData(Program):
    def __init__(self, data_path):
        ...
        # compute relative time in hrs vs first OD measurement
        self.t0 = self.ODs['time_s'][0]
        for df in list(dfs.values()) + [self.cells] + [self.LEDs_changes]:
